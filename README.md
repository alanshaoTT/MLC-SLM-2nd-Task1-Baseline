...
For Task 1, we fine-tune the challenge training set on Microsoft's open-source model VibeVoice-ASR. We use the Meeteval toolkit to compute tcpMER, where tcpCER is applied for Japanese, Korean, and Thai, while tcpWER is used for all other languages.
